...
<simconf>
  ...
  <simulation>
    <title>mqtt-sn-dtls-contiki</title>
    ...
    <motetype>
      ...
      <firmware EXPORT="copy">[CONTIKI_DIR]/mqtt_sn_dtls/main_core.wismote</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>10.502156636732884</x>
        <y>20.777360956298153</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>12.945989211320336</x>
        <y>20.0694092163132</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>18.69492746858287 0.0 0.0 18.69492746858287 -30.22069295105388 -216.0137028514217</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
